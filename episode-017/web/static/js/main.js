...
var _thaterikperson$elm_blackjack$Blackjack$serializeType = function (type_) {
	var _p0 = type_;
	switch (_p0.ctor) {
		case 'Two':
			return 0;
...
var _thaterikperson$elm_blackjack$Blackjack$serializeSuit = function (suit) {
	var _p1 = suit;
	switch (_p1.ctor) {
		case 'Clubs':
			return 0;
...
var _thaterikperson$elm_blackjack$Blackjack$cardValue = function (_p2) {
	var _p3 = _p2;
...
var _thaterikperson$elm_blackjack$Blackjack$isVirtualTen = function (_p5) {
	var _p6 = _p5;
...
var _thaterikperson$elm_blackjack$Blackjack$isBlackjack = function (_p8) {
	var _p9 = _p8;
	var _p10 = _p9._0;
...
var _thaterikperson$elm_blackjack$Blackjack$isSplittable = function (_p12) {
	var _p13 = _p12;
	var _p14 = _p13._0;
...
var _thaterikperson$elm_blackjack$Blackjack$typeOfCard = function (_p15) {
	var _p16 = _p15;
	return _p16._0.type_;
};
var _thaterikperson$elm_blackjack$Blackjack$suitOfCard = function (_p17) {
	var _p18 = _p17;
	return _p18._0.suit;
};
var _thaterikperson$elm_blackjack$Blackjack$BjHand = function (a) {
	return {ctor: 'BjHand', _0: a};
};
var _thaterikperson$elm_blackjack$Blackjack$newHand = _thaterikperson$elm_blackjack$Blackjack$BjHand(
	{ctor: '[]'});
var _thaterikperson$elm_blackjack$Blackjack$addCardToHand = F2(
	function (card, _p19) {
		var _p20 = _p19;
		return _thaterikperson$elm_blackjack$Blackjack$BjHand(
			{ctor: '::', _0: card, _1: _p20._0});
	});
var _thaterikperson$elm_blackjack$Blackjack$addCardsToHand = F2(
	function (cards, _p21) {
		var _p22 = _p21;
		return _thaterikperson$elm_blackjack$Blackjack$BjHand(
			A2(_elm_lang$core$Basics_ops['++'], cards, _p22._0));
	});
var _thaterikperson$elm_blackjack$Blackjack$BjCard = function (a) {
	return {ctor: 'BjCard', _0: a};
};
var _thaterikperson$elm_blackjack$Blackjack$newCard = F2(
	function (type_, suit) {
		return _thaterikperson$elm_blackjack$Blackjack$BjCard(
			{type_: type_, suit: suit});
	});
...
var _thaterikperson$elm_blackjack$Blackjack$hasAce = function (_p23) {
	var _p24 = _p23;
	return A2(
		_elm_lang$core$List$any,
		function (_p25) {
...
var _thaterikperson$elm_blackjack$Blackjack$potentialScores = function (_p27) {
	var _p28 = _p27;
	var func = F2(
		function (_p29, scores) {
			var _p30 = _p29;
			var plus11 = A2(
				_elm_lang$core$List$map,
				function (s) {
	...
	var aces = _p31._0;
	var noAces = _p31._1;
	var preAcesSum = _elm_lang$core$List$sum(
		A2(_elm_lang$core$List$map, _thaterikperson$elm_blackjack$Blackjack$cardValue, noAces));
	var afterAces = A3(
		_elm_lang$core$List$foldl,
		func,
		{
...
var _thaterikperson$elm_blackjack$Blackjack$bestScore = function (hand) {
	var goodScores = A2(
	...
	return A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		_elm_lang$core$List$head(goodScores));
};
var _thaterikperson$elm_blackjack$Blackjack$isBust = function (hand) {
	return _elm_lang$core$Native_Utils.eq(
		_thaterikperson$elm_blackjack$Blackjack$bestScore(hand),
		0);
};
var _thaterikperson$elm_blackjack$Blackjack$isTwentyOne = function (hand) {
	return _elm_lang$core$Native_Utils.eq(
		_thaterikperson$elm_blackjack$Blackjack$bestScore(hand),
		21);
};
var _thaterikperson$elm_blackjack$Blackjack$isHandBetterThan = F2(
	function (hand1, hand2) {
		return _elm_lang$core$Native_Utils.cmp(
			_thaterikperson$elm_blackjack$Blackjack$bestScore(hand1),
			_thaterikperson$elm_blackjack$Blackjack$bestScore(hand2)) > 0;
	});
var _thaterikperson$elm_blackjack$Blackjack$isHandTiedWith = F2(
	function (hand1, hand2) {
		return _elm_lang$core$Native_Utils.eq(
			_thaterikperson$elm_blackjack$Blackjack$bestScore(hand1),
			_thaterikperson$elm_blackjack$Blackjack$bestScore(hand2));
	});
var _thaterikperson$elm_blackjack$Blackjack$deserializeType = function (type_) {
	var _p34 = type_;
	switch (_p34) {
		case 0:
...
var _thaterikperson$elm_blackjack$Blackjack$deserializeSuit = function (suit) {
	var _p35 = suit;
	switch (_p35) {
		case 0:
...
var _thaterikperson$elm_blackjack$Blackjack$deserializeCard = F2(
	function (type_, suit) {
		return _thaterikperson$elm_blackjack$Blackjack$BjCard(
			{
...
var _user$project$Routes$pageToPath = function (page) {
	var _p0 = page;
	switch (_p0.ctor) {
		case 'Home':
			return '/';
...
var _user$project$Routes$Theme = function (a) {
...
var _user$project$Routes$pageParser = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_1: {
			...
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Routes$About,
				_evancz$url_parser$UrlParser$s('about')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Routes$Theme,
					A2(
						_evancz$url_parser$UrlParser_ops['</>'],
						_evancz$url_parser$UrlParser$s('theme'),
...
var _user$project$Model$updateModelFromErrorType = F2(
	function (error, model) {
		var _p0 = error;
		if (_p0.ctor === 'LocallyStoreError') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
...
var _user$project$Model$locallyStore = function (model) {
...
var _user$project$Model$shuffle = F3(
	function (unshuffled, i, seed) {
		...
		while (true) {
			...
			var _p1 = A2(_elm_lang$core$Random$step, g, seed);
			var j = _p1._0;
			var nextSeed = _p1._1;
			var mAtIJ = A2(_elm_lang$core$Array$get, i + j, unshuffled);
			var shuffled = function () {
				var _p2 = {ctor: '_Tuple2', _0: mAtI, _1: mAtIJ};
				if (((_p2.ctor === '_Tuple2') && (_p2._0.ctor === 'Just')) && (_p2._1.ctor === 'Just')) {
					return A3(
						_elm_lang$core$Array$set,
						i + j,
						_p2._0._0,
						A3(_elm_lang$core$Array$set, i, _p2._1._0, unshuffled));
				} else {
					return unshuffled;
				}
			}();
...
var _user$project$Model$shuffledDeck = function (time) {
	...
	var cardsWithSuits = A2(
		_elm_lang$core$List$concatMap,
		function (type_) {
			return A2(
				_elm_lang$core$List$map,
				_thaterikperson$elm_blackjack$Blackjack$newCard(type_),
				suits);
		},
		types);
...
var _user$project$Model$ServerResponse = F4(
	function (a, b, c, d) {
...
var _user$project$Model$NavigateTo = function (a) {
	return {ctor: 'NavigateTo', _0: a};
};
var _user$project$Model$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$project$Model$Storage = function (a) {
	return {ctor: 'Storage', _0: a};
};
var _user$project$Model$CurrentTick = function (a) {
	return {ctor: 'CurrentTick', _0: a};
};
var _user$project$Model$DealHand = {ctor: 'DealHand'};
var _user$project$Model$RemotelyStoreError = function (a) {
	return {ctor: 'RemotelyStoreError', _0: a};
};
var _user$project$Model$LocallyStoreError = function (a) {
...
var _user$project$Model$toCasino = function (num) {
	var _p3 = num;
	switch (_p3) {
		case 0:
...
var _user$project$View$onLinkClick = function (msg) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'click',
...
var _user$project$View$aboutView = function (model) {
	return A2(
													...
													_elm_lang$html$Html$a,
													{
														...
														_1: {
															...
															_0: _user$project$View$onLinkClick(
																_user$project$Model$NavigateTo(_user$project$Routes$About)),
															_1: {ctor: '[]'}
														}
													},
													{
...
var _user$project$View$dateToString = function (date) {
	var month = function () {
...
var _user$project$View$cardToText = function (card) {
	var typeText = function () {
		var _p1 = _thaterikperson$elm_blackjack$Blackjack$typeOfCard(card);
		switch (_p1.ctor) {
			case 'Ace':
				return 'A';
			case 'King':
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		typeText,
		A2(_elm_lang$core$Basics_ops['++'], ' ', suitText));
};
var _user$project$View$customThemeView = F2(
	function (theme, model) {
		var deckView = A2(
			...
			{ctor: '[]'});
		var x = function () {
			var _p3 = model.activeAnimation;
			if (_p3.ctor === 'Nothing') {
				return 0;
			} else {
				return A2(_mgold$elm_animation$Animation$animate, model.currentTick, _p3._0);
			}
		}();
		var cardLabel = function (c) {
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						_user$project$View$cardToText(c)),
					_1: {ctor: '[]'}
				});
		};
		var blank = A2(
		...
		var previousCardView = function () {
			var _p5 = model.previousCard;
			if (_p5.ctor === 'Nothing') {
				return blank;
			} else {
				return A2(
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_0: {
										...
										_1: A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(x * 2),
											'px')
									},
									_1: {ctor: '[]'}
								}),
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'container ', theme)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('twelve columns links'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href('/theme/black'),
										_1: {
											ctor: '::',
											_0: _user$project$View$onLinkClick(
												_user$project$Model$NavigateTo(
													_user$project$Routes$Theme('black'))),
											_1: {ctor: '[]'}
										}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Black Theme'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href('/theme/blue'),
											_1: {
												ctor: '::',
												_0: _user$project$View$onLinkClick(
													_user$project$Model$NavigateTo(
														_user$project$Routes$Theme('blue'))),
												_1: {ctor: '[]'}
											}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Blue Theme'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('/theme/red'),
												_1: {
													ctor: '::',
													_0: _user$project$View$onLinkClick(
														_user$project$Model$NavigateTo(
															_user$project$Routes$Theme('red'))),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Red Theme'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('row card-row'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$View$homeView = function (model) {
...
var _user$project$View$mainView = function (model) {
	...
	switch (_p7.ctor) {
		...
		default:
			return A2(_user$project$View$customThemeView, _p7._0, model);
	}
};

var _user$project$Main$toServerResponse = F4(
	function (status, hands, wins, casino) {
		var casinoResult = A2(
			...
			casino);
		var favoriteCasino = A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$Model$Unknown,
			A2(_elm_lang$core$Maybe$andThen, _user$project$Model$toCasino, casinoResult));
		return A4(_user$project$Model$ServerResponse, status, hands, wins, favoriteCasino);
	});
var _user$project$Main$httpErrorToString = function (error) {
	var _p1 = error;
	switch (_p1.ctor) {
		case 'Timeout':
			return 'Timeout';
...
var _user$project$Main$remotelyStore = F2(
	function (counter, model) {
		...
		var decoder = A5(
			...
			_user$project$Main$toServerResponse,
			A2(_elm_lang$core$Json_Decode$field, 'status', _elm_lang$core$Json_Decode$string),
			A2(_elm_lang$core$Json_Decode$field, 'number_of_hands', _elm_lang$core$Json_Decode$int),
			A2(_elm_lang$core$Json_Decode$field, 'number_of_wins', _elm_lang$core$Json_Decode$int),
			A2(
				_elm_lang$core$Json_Decode$field,
				'favorite_casino',
				_elm_lang$core$Json_Decode$maybe(_elm_lang$core$Json_Decode$string)));
		return _elm_lang$http$Http$toTask(
			A3(_elm_lang$http$Http$post, url, _elm_lang$http$Http$emptyBody, decoder));
	});
var _user$project$Main$locallyStore = function (model) {
	return _user$project$Model$locallyStore(model);
};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		var leftCard = _p2._0;
		var rightCard = _p2._1;
		var remainingCards = _p2._2;
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'DealHand':
				var remoteTask = function (value) {
					return A2(
						_elm_lang$core$Task$mapError,
						function (_p5) {
							return _user$project$Model$RemotelyStoreError(
								_user$project$Main$httpErrorToString(_p5));
						},
						A2(_user$project$Main$remotelyStore, value, model));
				};
				var updated = _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						activeAnimation: _elm_lang$core$Maybe$Just(
							A2(
								...
								A2(
									...
									A2(
										...
										0,
										_mgold$elm_animation$Animation$animation(model.currentTick)))))
					});
				var localTask = A2(
					_elm_lang$core$Task$mapError,
					_user$project$Model$LocallyStoreError,
					_user$project$Main$locallyStore(updated));
				var cmd = A2(
					_elm_lang$core$Task$attempt,
					_user$project$Model$Storage,
					A2(_elm_lang$core$Task$andThen, remoteTask, localTask));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					updated,
					{
			...
			case 'UrlChange':
				var _p7 = _p4._0;
				var _p6 = A2(_elm_lang$core$Debug$log, 'UrlChange', _p7);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Main$modelWithLocation, _p7, model),
					{ctor: '[]'});
			case 'NavigateTo':
				var cmd = _elm_lang$navigation$Navigation$newUrl(
					_user$project$Routes$pageToPath(_p4._0));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
			...
			default:
				if (_p4._0.ctor === 'Err') {
					var updated = A2(_user$project$Model$updateModelFromErrorType, _p4._0._0, model);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updated,
						{ctor: '[]'});
					...
					var updated = _elm_lang$core$Native_Utils.update(
						model,
						{numberOfHands: _p8.numberOfHands, numberOfWins: _p8.numberOfWins, favoriteCasino: _p8.favoriteCasino});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updated,
						{ctor: '[]'});
...
var _user$project$Main$initialState = function (location) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		A2(_user$project$Main$modelWithLocation, location, _user$project$Model$initialModel),
		{ctor: '[]'});
};
var _user$project$Main$main = A2(
	...
	_user$project$Model$UrlChange,
	{
		...
		subscriptions: function (_p9) {
			return _elm_lang$animation_frame$AnimationFrame$times(_user$project$Model$CurrentTick);
		}
	})();
