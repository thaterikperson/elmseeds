...
(function () {
	...
	var _user$project$View$navView = function _user$project$View$navView(model) {
		return A2(_elm_lang$html$Html$nav, { ctor: '[]' }, {
			ctor: '::',
			_0: A2(_elm_lang$html$Html$div, {
				ctor: '::',
				...
				_0: A2(_elm_lang$html$Html$a, {
					...
					_1: {
						ctor: '::',
						_0: _user$project$View$onLinkClick(_user$project$Model$ToggleMenu),
						_1: { ctor: '[]' }
					}
				}, {
					ctor: '::',
				...
				_1: {
					...
					_0: A2(_elm_lang$html$Html$span, {
						...
						ctor: '::',
						_0: _elm_lang$html$Html$text('Elm Blackjack'),
						_1: { ctor: '[]' }
					}),
					_1: { ctor: '[]' }
				}
			...
			_1: {
				...
				_0: A2(_elm_lang$html$Html$div, {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('submenu-w'),
					_1: { ctor: '[]' }
				}, {
					ctor: '::',
					_0: A2(_elm_lang$html$Html$div, {
						...
						_0: A2(_elm_lang$html$Html$a, {
							...
							_1: {
								ctor: '::',
								_0: _user$project$View$onLinkClick(_user$project$Model$NavigateTo(_user$project$Routes$Home)),
								_1: { ctor: '[]' }
							}
						}, {
							ctor: '::',
						...
						_1: {
							...
							_0: A2(_elm_lang$html$Html$a, {
								...
								_1: {
									ctor: '::',
									_0: _user$project$View$onLinkClick(_user$project$Model$NavigateTo(_user$project$Routes$Theme('blue'))),
									_1: { ctor: '[]' }
								}
							}, {
								ctor: '::',
							...
							_1: {
								...
								_0: A2(_elm_lang$html$Html$a, {
									...
									_1: {
										ctor: '::',
										_0: _user$project$View$onLinkClick(_user$project$Model$NavigateTo(_user$project$Routes$Theme('red'))),
										_1: { ctor: '[]' }
									}
								}, {
									ctor: '::',
	...
	var _user$project$View$mainView = function _user$project$View$mainView(model) {
		...
		return A2(_elm_lang$html$Html$div, { ctor: '[]' }, {
			ctor: '::',
			_0: _user$project$View$navView(model),
			_1: {
				ctor: '::',
				_0: bodyView,
				_1: { ctor: '[]' }
