...
require.register("web/static/elm/Detail/Main.elm", function(exports, require, module) {

});

;require.register("web/static/elm/Lists/Main.elm", function(exports, require, module) {
...
;require.register("web/static/elm/Server/Main.elm", function(exports, require, module) {
...
(function () {
	...
	var _ccapndave$elm_update_extra$Update_Extra$identity = function _ccapndave$elm_update_extra$Update_Extra$identity(model) {
		return A2(_elm_lang$core$Platform_Cmd_ops['!'], model, { ctor: '[]' });
	};
	var _ccapndave$elm_update_extra$Update_Extra$mapCmd = F2(function (tagger, _p0) {
		var _p1 = _p0;
		return {
			ctor: '_Tuple2',
			_0: _p1._0,
	...
	var _ccapndave$elm_update_extra$Update_Extra$addCmd = F2(function (cmd_, _p2) {
		var _p3 = _p2;
		return {
			ctor: '_Tuple2',
			_0: _p3._0,
	...
	var _ccapndave$elm_update_extra$Update_Extra$updateModel = F2(function (f, _p4) {
		var _p5 = _p4;
		return {
			ctor: '_Tuple2',
			_0: f(_p5._0),
	...
	var _ccapndave$elm_update_extra$Update_Extra$filter = F2(function (pred, f) {
		return pred ? f : _elm_lang$core$Basics$identity;
	});
	var _ccapndave$elm_update_extra$Update_Extra$andThen = F3(function (update, msg, _p6) {
		var _p7 = _p6;
	...
	var _ccapndave$elm_update_extra$Update_Extra$sequence = F3(function (update, msgs, init) {
	...
	var _user$project$Model$initialModel = { lists: _elm_lang$core$Dict$empty, details: _elm_lang$core$Dict$empty, nextId: 1 };
	var _user$project$Model$Model = F3(function (a, b, c) {
		return { lists: a, details: b, nextId: c };
	});
	var _user$project$Model$Detail = F3(function (a, b, c) {
		return { id: a, name: b, count: c };
	});
	var _user$project$Model$DetailMsg = function _user$project$Model$DetailMsg(a) {
		return { ctor: 'DetailMsg', _0: a };
	};
	var _user$project$Model$ListsMsg = function _user$project$Model$ListsMsg(a) {
		return { ctor: 'ListsMsg', _0: a };
	};
	var _user$project$Model$ServerMsg = function _user$project$Model$ServerMsg(a) {
		return { ctor: 'ServerMsg', _0: a };
	};
	var _user$project$Model$Save = { ctor: 'Save' };
	var _user$project$Model$Delete = function _user$project$Model$Delete(a) {
		return { ctor: 'Delete', _0: a };
	};
	var _user$project$Model$Create = function _user$project$Model$Create(a) {
		return { ctor: 'Create', _0: a };
	};
	var _user$project$Model$Edit = F3(function (a, b, c) {
		return { ctor: 'Edit', _0: a, _1: b, _2: c };
	});
	var _user$project$Model$Show = F2(function (a, b) {
		return { ctor: 'Show', _0: a, _1: b };
	});

	var _user$project$Lists_Main$update = F2(function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Create') {
			var _p2 = _p0._0;
			var list = _elm_lang$core$List$head(A2(_elm_lang$core$List$filter, function (n) {
				return _elm_lang$core$Native_Utils.eq(n, _p2);
			}, _elm_lang$core$Dict$values(model.lists)));
			var _p1 = list;
			if (_p1.ctor === 'Nothing') {
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
					lists: A3(_elm_lang$core$Dict$insert, _elm_lang$core$Basics$toString(model.nextId), _p2, model.lists),
			...
			return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
				lists: A2(_elm_lang$core$Dict$remove, _p0._0, model.lists)
			}), { ctor: '[]' });
		}
	});

	var _user$project$Server_Main$update = F2(function (msg, model) {
		var _p0 = msg;
		return A2(_elm_lang$core$Platform_Cmd_ops['!'], model, { ctor: '[]' });
	});

	var _user$project$Detail_Main$updateDetail = F3(function (id, name, model) {
		var detail = A2(_elm_lang$core$Maybe$withDefault, A3(_user$project$Model$Detail, id, name, 0), A2(_elm_lang$core$Maybe$map, function (d) {
			return _elm_lang$core$Native_Utils.update(d, { name: name });
		}, A2(_elm_lang$core$Dict$get, id, model.details)));
		return _elm_lang$core$Native_Utils.update(model, {
			details: A3(_elm_lang$core$Dict$insert, id, detail, model.details)
		});
	});
	var _user$project$Detail_Main$andThen = F3(function (update, msg, _p0) {
		var _p1 = _p0;
		var _p2 = A2(update, msg, _p1._0);
		var model_ = _p2._0;
		var cmd_ = _p2._1;
		return {
			ctor: '_Tuple2',
	...
	var _user$project$Detail_Main$writeToLocalStorage = _elm_lang$core$Native_Platform.outgoingPort('writeToLocalStorage', function (v) {
		return v;
	});
	var _user$project$Detail_Main$update = F2(function (msg, model) {
		var _p3 = msg;
		if (_p3.ctor === 'Show') {
			return A2(_elm_lang$core$Platform_Cmd_ops['!'], model, { ctor: '[]' });
		} else {
			var _p5 = _p3._2;
			var _p4 = _p3._1;
			return A2(_ccapndave$elm_update_extra$Update_Extra$addCmd, _user$project$Detail_Main$writeToLocalStorage(_p5), A3(_user$project$Detail_Main$andThen, _user$project$Server_Main$update, _user$project$Model$Save, A2(_elm_lang$core$Tuple$mapFirst, A2(_user$project$Detail_Main$updateDetail, _p4, _p5), A2(_ccapndave$elm_update_extra$Update_Extra$updateModel, A2(_user$project$Detail_Main$updateDetail, _p4, _p5), A2(_user$project$Lists_Main$update, _user$project$Model$Create(_p3._0), model)))));
		}
	});
	...
	var _user$project$Main$update = F2(function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'ServerMsg':
				return A2(_user$project$Server_Main$update, _p0._0, model);
			case 'ListsMsg':
				return A2(_user$project$Lists_Main$update, _p0._0, model);
			default:
				return A2(_user$project$Detail_Main$update, _p0._0, model);
		}
	});
	...
	if (typeof _user$project$Main$main !== 'undefined') {
		_user$project$Main$main(Elm['Main'], 'Main', { "types": { "unions": { "Model.Msg": { "args": [], "tags": { "ServerMsg": ["Model.MsgServer"], "ListsMsg": ["Model.MsgLists"], "DetailMsg": ["Model.MsgDetail"] } }, "Model.MsgServer": { "args": [], "tags": { "Save": [] } }, "Model.MsgLists": { "args": [], "tags": { "Create": ["String"], "Delete": ["String"] } }, "Model.MsgDetail": { "args": [], "tags": { "Edit": ["String", "String", "String"], "Show": ["String", "String"] } } }, "aliases": {}, "message": "Model.Msg" }, "versions": { "elm": "0.18.0" } });
	}
