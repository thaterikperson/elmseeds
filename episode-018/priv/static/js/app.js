...
(function () {
	...
	var _elm_community$easing_functions$Ease$reverse = F2(function (easing, time) {
		return easing(1 - time);
	});
	var _elm_community$easing_functions$Ease$flip = F2(function (easing, time) {
		return 1 - easing(1 - time);
	});
	var _elm_community$easing_functions$Ease$retour = F2(function (easing, time) {
	...
	var _elm_community$easing_functions$Ease$inOut = F3(function (e1, e2, time) {
		return _elm_lang$core$Native_Utils.cmp(time, 0.5) < 0 ? e1(time * 2) / 2 : 0.5 + e2((time - 0.5) * 2) / 2;
	});
	var _elm_community$easing_functions$Ease$inElastic = function _elm_community$easing_functions$Ease$inElastic(time) {
	...
	var _elm_community$easing_functions$Ease$outBounce = function _elm_community$easing_functions$Ease$outBounce(time) {
	...
	var _elm_community$easing_functions$Ease$inBack = function _elm_community$easing_functions$Ease$inBack(time) {
	...
	var _elm_community$easing_functions$Ease$outCirc = function _elm_community$easing_functions$Ease$outCirc(time) {
		return _elm_lang$core$Basics$sqrt(1 - Math.pow(time - 1, 2));
	};
	...
	var _elm_community$easing_functions$Ease$inExpo = function _elm_community$easing_functions$Ease$inExpo(time) {
	...
	var _elm_community$easing_functions$Ease$outSine = function _elm_community$easing_functions$Ease$outSine(time) {
	...
	var _elm_community$easing_functions$Ease$inQuint = function _elm_community$easing_functions$Ease$inQuint(time) {
	...
	var _elm_community$easing_functions$Ease$inQuart = function _elm_community$easing_functions$Ease$inQuart(time) {
	...
	var _elm_community$easing_functions$Ease$inCubic = function _elm_community$easing_functions$Ease$inCubic(time) {
	...
	var _elm_community$easing_functions$Ease$inQuad = function _elm_community$easing_functions$Ease$inQuad(time) {
	...
	var _elm_community$easing_functions$Ease$bezier = F5(function (x1, y1, x2, y2, time) {
		...
		var lerp = F3(function (from, to, v) {
			return from + (to - from) * v;
		});
		var casteljau = function casteljau(ps) {
			casteljau: while (true) {
				...
				if (_p4.ctor === '::' && _p4._0.ctor === '_Tuple2' && _p4._1.ctor === '[]') {
					...
					var _p5 = _p4;
					var _v3 = A3(_elm_lang$core$List$map2, F2(function (x, y) {
						return A4(pair, lerp, x, y, time);
					}), _p5, A2(_elm_lang$core$Maybe$withDefault, { ctor: '[]' }, _elm_lang$core$List$tail(_p5)));
					ps = _v3;
					continue casteljau;
				}
			}
	...
	var _elm_lang$animation_frame$AnimationFrame$rAF = _elm_lang$animation_frame$Native_AnimationFrame.create({ ctor: '_Tuple0' });
	var _elm_lang$animation_frame$AnimationFrame$subscription = _elm_lang$core$Native_Platform.leaf('AnimationFrame');
	var _elm_lang$animation_frame$AnimationFrame$State = F3(function (a, b, c) {
		return { subs: a, request: b, oldTime: c };
	});
	var _elm_lang$animation_frame$AnimationFrame$init = _elm_lang$core$Task$succeed(A3(_elm_lang$animation_frame$AnimationFrame$State, { ctor: '[]' }, _elm_lang$core$Maybe$Nothing, 0));
	var _elm_lang$animation_frame$AnimationFrame$onEffects = F3(function (router, subs, _p0) {
		var _p1 = _p0;
		var _p5 = _p1.request;
		var _p4 = _p1.oldTime;
		...
		if (_p2._0.ctor === 'Nothing') {
			if (_p2._1.ctor === '[]') {
				return _elm_lang$core$Task$succeed(A3(_elm_lang$animation_frame$AnimationFrame$State, { ctor: '[]' }, _elm_lang$core$Maybe$Nothing, _p4));
			} else {
				return A2(_elm_lang$core$Task$andThen, function (pid) {
					return A2(_elm_lang$core$Task$andThen, function (time) {
						return _elm_lang$core$Task$succeed(A3(_elm_lang$animation_frame$AnimationFrame$State, subs, _elm_lang$core$Maybe$Just(pid), time));
					}, _elm_lang$core$Time$now);
				}, _elm_lang$core$Process$spawn(A2(_elm_lang$core$Task$andThen, _elm_lang$core$Platform$sendToSelf(router), _elm_lang$animation_frame$AnimationFrame$rAF)));
			}
		} else {
			if (_p2._1.ctor === '[]') {
				...
				return _elm_lang$core$Task$succeed(A3(_elm_lang$animation_frame$AnimationFrame$State, subs, _p5, _p4));
			}
		}
	});
	var _elm_lang$animation_frame$AnimationFrame$onSelfMsg = F3(function (router, newTime, _p6) {
		var _p7 = _p6;
		var _p10 = _p7.subs;
		var diff = newTime - _p7.oldTime;
		var send = function send(sub) {
			var _p8 = sub;
			if (_p8.ctor === 'Time') {
				return A2(_elm_lang$core$Platform$sendToApp, router, _p8._0(newTime));
			} else {
				return A2(_elm_lang$core$Platform$sendToApp, router, _p8._0(diff));
			}
		};
		return A2(_elm_lang$core$Task$andThen, function (pid) {
			return A2(_elm_lang$core$Task$andThen, function (_p9) {
				return _elm_lang$core$Task$succeed(A3(_elm_lang$animation_frame$AnimationFrame$State, _p10, _elm_lang$core$Maybe$Just(pid), newTime));
			}, _elm_lang$core$Task$sequence(A2(_elm_lang$core$List$map, send, _p10)));
		}, _elm_lang$core$Process$spawn(A2(_elm_lang$core$Task$andThen, _elm_lang$core$Platform$sendToSelf(router), _elm_lang$animation_frame$AnimationFrame$rAF)));
	});
	var _elm_lang$animation_frame$AnimationFrame$Diff = function _elm_lang$animation_frame$AnimationFrame$Diff(a) {
		return { ctor: 'Diff', _0: a };
	};
	var _elm_lang$animation_frame$AnimationFrame$diffs = function _elm_lang$animation_frame$AnimationFrame$diffs(tagger) {
		return _elm_lang$animation_frame$AnimationFrame$subscription(_elm_lang$animation_frame$AnimationFrame$Diff(tagger));
	};
	var _elm_lang$animation_frame$AnimationFrame$Time = function _elm_lang$animation_frame$AnimationFrame$Time(a) {
		return { ctor: 'Time', _0: a };
	};
	var _elm_lang$animation_frame$AnimationFrame$times = function _elm_lang$animation_frame$AnimationFrame$times(tagger) {
		return _elm_lang$animation_frame$AnimationFrame$subscription(_elm_lang$animation_frame$AnimationFrame$Time(tagger));
	};
	var _elm_lang$animation_frame$AnimationFrame$subMap = F2(function (func, sub) {
		var _p11 = sub;
		if (_p11.ctor === 'Time') {
			return _elm_lang$animation_frame$AnimationFrame$Time(function (_p12) {
				return func(_p11._0(_p12));
			});
		} else {
			return _elm_lang$animation_frame$AnimationFrame$Diff(function (_p13) {
				return func(_p11._0(_p13));
			});
		}
	});
	...
	var _elm_lang$navigation$Navigation$spawnPopState = function _elm_lang$navigation$Navigation$spawnPopState(router) {
		return _elm_lang$core$Process$spawn(A3(_elm_lang$dom$Dom_LowLevel$onWindow, 'popstate', _elm_lang$core$Json_Decode$value, function (_p0) {
	...
	_elm_lang$navigation$Navigation_ops['&>'] = F2(function (task1, task2) {
		return A2(_elm_lang$core$Task$andThen, function (_p1) {
			return task2;
		}, task1);
	});
	var _elm_lang$navigation$Navigation$notify = F3(function (router, subs, location) {
		var send = function send(_p2) {
			var _p3 = _p2;
			return A2(_elm_lang$core$Platform$sendToApp, router, _p3._0(location));
		};
	...
	var _elm_lang$navigation$Navigation$cmdHelp = F3(function (router, subs, cmd) {
		...
		switch (_p4.ctor) {
			...
			case 'New':
				return A2(_elm_lang$core$Task$andThen, A2(_elm_lang$navigation$Navigation$notify, router, subs), _elm_lang$navigation$Navigation$pushState(_p4._0));
			default:
				return A2(_elm_lang$core$Task$andThen, A2(_elm_lang$navigation$Navigation$notify, router, subs), _elm_lang$navigation$Navigation$replaceState(_p4._0));
		}
	});
	...
	var _elm_lang$navigation$Navigation$onEffects = F4(function (router, cmds, subs, _p5) {
		var _p6 = _p5;
		var _p9 = _p6.process;
		var stepState = function () {
			...
			_v3_2: do {
				if (_p7._0.ctor === '[]') {
					if (_p7._1.ctor === 'Just') {
						return A2(_elm_lang$navigation$Navigation_ops['&>'], _elm_lang$core$Process$kill(_p7._1._0), _elm_lang$core$Task$succeed(A2(_elm_lang$navigation$Navigation$State, subs, _elm_lang$core$Maybe$Nothing)));
					} else {
						break _v3_2;
					}
				} else {
					if (_p7._1.ctor === 'Nothing') {
						return A2(_elm_lang$core$Task$map, function (_p8) {
							return A2(_elm_lang$navigation$Navigation$State, subs, _elm_lang$core$Maybe$Just(_p8));
			...
			return _elm_lang$core$Task$succeed(A2(_elm_lang$navigation$Navigation$State, subs, _p9));
		}();
	...
	var _elm_lang$navigation$Navigation$cmdMap = F2(function (_p10, myCmd) {
		var _p11 = myCmd;
		switch (_p11.ctor) {
			case 'Jump':
	...
	var _elm_lang$navigation$Navigation$subMap = F2(function (func, _p12) {
		var _p13 = _p12;
		return _elm_lang$navigation$Navigation$Monitor(function (_p14) {
			return func(_p13._0(_p14));
		});
	});
	...
	var _mgold$elm_animation$Animation$isStatic = function _mgold$elm_animation$Animation$isStatic(_p0) {
		var _p1 = _p0;
		return _elm_lang$core$Native_Utils.eq(_p1._0.from, _p1._0.to);
	};
	var _mgold$elm_animation$Animation$isScheduled = F2(function (t, _p2) {
		var _p3 = _p2;
		return _elm_lang$core$Native_Utils.cmp(t, _p3._0.start + _p3._0.delay) < 1 && !_mgold$elm_animation$Animation$isStatic(_p3);
	});
	var _mgold$elm_animation$Animation$getTo = function _mgold$elm_animation$Animation$getTo(_p4) {
		var _p5 = _p4;
		return _p5._0.to;
	};
	var _mgold$elm_animation$Animation$getFrom = function _mgold$elm_animation$Animation$getFrom(_p6) {
		var _p7 = _p6;
		return _p7._0.from;
	};
	var _mgold$elm_animation$Animation$getEase = function _mgold$elm_animation$Animation$getEase(_p8) {
		var _p9 = _p8;
		return _p9._0.ease;
	};
	var _mgold$elm_animation$Animation$getDelay = function _mgold$elm_animation$Animation$getDelay(_p10) {
		var _p11 = _p10;
		return _p11._0.delay;
	};
	var _mgold$elm_animation$Animation$getStart = function _mgold$elm_animation$Animation$getStart(_p12) {
		var _p13 = _p12;
		return _p13._0.start;
	};
	var _mgold$elm_animation$Animation$timeElapsed = F2(function (t, _p14) {
		var _p15 = _p14;
		return A2(_elm_lang$core$Basics$max, 0, t - (_p15._0.start + _p15._0.delay));
	});
	var _mgold$elm_animation$Animation$defaultEase = function _mgold$elm_animation$Animation$defaultEase(x) {
		return (1 - _elm_lang$core$Basics$cos(_elm_lang$core$Basics$pi * x)) / 2;
	};
	var _mgold$elm_animation$Animation$spd = F3(function (dos, from, to) {
		var _p16 = dos;
	...
	var _mgold$elm_animation$Animation$getSpeed = function _mgold$elm_animation$Animation$getSpeed(_p17) {
		var _p18 = _p17;
		return A3(_mgold$elm_animation$Animation$spd, _p18._0.dos, _p18._0.from, _p18._0.to);
	};
	var _mgold$elm_animation$Animation$dur = F3(function (dos, from, to) {
		var _p19 = dos;
	...
	var _mgold$elm_animation$Animation$animate = F2(function (t, _p20) {
		var _p21 = _p20;
		var _p25 = _p21._0.to;
	...
	var _mgold$elm_animation$Animation$velocity = F2(function (t, u) {
	...
	var _mgold$elm_animation$Animation$timeRemaining = F2(function (t, _p26) {
		var _p27 = _p26;
	...
	var _mgold$elm_animation$Animation$getDuration = function _mgold$elm_animation$Animation$getDuration(_p28) {
		var _p29 = _p28;
		return A3(_mgold$elm_animation$Animation$dur, _p29._0.dos, _p29._0.from, _p29._0.to);
	};
	var _mgold$elm_animation$Animation$equals = F2(function (_p31, _p30) {
		var _p32 = _p31;
		var _p35 = _p32._0;
		var _p33 = _p30;
		var _p34 = _p33._0;
		return _elm_lang$core$Native_Utils.eq(_p35.start + _p35.delay, _p34.start + _p34.delay) && _elm_lang$core$Native_Utils.eq(_p35.from, _p34.from) && _elm_lang$core$Native_Utils.eq(_p35.to, _p34.to) && _elm_lang$core$Native_Utils.eq(_p35.ramp, _p34.ramp) && (_elm_lang$core$Native_Utils.eq(_p35.dos, _p34.dos) || _elm_lang$core$Native_Utils.cmp(1.0e-3, _elm_lang$core$Basics$abs(A3(_mgold$elm_animation$Animation$dur, _p35.dos, _p35.from, _p35.to) - A3(_mgold$elm_animation$Animation$dur, _p34.dos, _p34.from, _p34.to))) > -1) && A2(_elm_lang$core$List$all, function (t) {
			return _elm_lang$core$Native_Utils.eq(_p35.ease(t), _p34.ease(t));
		}, {
			ctor: '::',
			_0: 0.1,
			_1: {
	...
	var _mgold$elm_animation$Animation$isRunning = F2(function (t, _p36) {
		var _p37 = _p36;
	...
	var _mgold$elm_animation$Animation$isDone = F2(function (t, _p40) {
		var _p41 = _p40;
	...
	var _mgold$elm_animation$Animation$AnimRecord = F7(function (a, b, c, d, e, f, g) {
		return { start: a, delay: b, dos: c, ramp: d, ease: e, from: f, to: g };
	});
	var _mgold$elm_animation$Animation$Speed = function _mgold$elm_animation$Animation$Speed(a) {
		return { ctor: 'Speed', _0: a };
	};
	var _mgold$elm_animation$Animation$Duration = function _mgold$elm_animation$Animation$Duration(a) {
	...
	var _mgold$elm_animation$Animation$A = function _mgold$elm_animation$Animation$A(a) {
		return { ctor: 'A', _0: a };
	};
	var _mgold$elm_animation$Animation$animation = function _mgold$elm_animation$Animation$animation(t) {
		return _mgold$elm_animation$Animation$A(A7(_mgold$elm_animation$Animation$AnimRecord, t, 0, _mgold$elm_animation$Animation$defaultDuration, _elm_lang$core$Maybe$Nothing, _mgold$elm_animation$Animation$defaultEase, 0, 1));
	};
	var _mgold$elm_animation$Animation$static = function _mgold$elm_animation$Animation$static(x) {
		return _mgold$elm_animation$Animation$A(A7(_mgold$elm_animation$Animation$AnimRecord, 0, 0, _mgold$elm_animation$Animation$defaultDuration, _elm_lang$core$Maybe$Nothing, _mgold$elm_animation$Animation$defaultEase, x, x));
	};
	var _mgold$elm_animation$Animation$undo = F2(function (t, _p42) {
		var _p43 = _p42;
		var _p44 = _p43._0;
		return _mgold$elm_animation$Animation$A(_elm_lang$core$Native_Utils.update(_p44, {
			from: _p44.to,
			to: _p44.from,
			start: t,
	...
	var _mgold$elm_animation$Animation$retarget = F3(function (t, newTo, _p45) {
		var _p46 = _p45;
		var _p49 = _p46;
		var _p48 = _p46._0;
		if (_elm_lang$core$Native_Utils.eq(newTo, _p48.to)) {
			...
			if (_mgold$elm_animation$Animation$isStatic(_p49)) {
				return _mgold$elm_animation$Animation$A(_elm_lang$core$Native_Utils.update(_p48, { start: t, to: newTo, ramp: _elm_lang$core$Maybe$Nothing }));
			} else {
				if (A2(_mgold$elm_animation$Animation$isScheduled, t, _p49)) {
					return _mgold$elm_animation$Animation$A(_elm_lang$core$Native_Utils.update(_p48, { to: newTo, ramp: _elm_lang$core$Maybe$Nothing }));
				} else {
					if (A2(_mgold$elm_animation$Animation$isDone, t, _p49)) {
						return _mgold$elm_animation$Animation$A(_elm_lang$core$Native_Utils.update(_p48, { start: t, delay: 0, from: _p48.to, to: newTo, ramp: _elm_lang$core$Maybe$Nothing }));
					} else {
						var newSpeed = function () {
							...
							if (_p47.ctor === 'Speed') {
								...
								return _mgold$elm_animation$Animation$Speed(A3(_mgold$elm_animation$Animation$spd, _p48.dos, _p48.from, _p48.to));
							}
						}();
						var pos = A2(_mgold$elm_animation$Animation$animate, t, _p49);
						var vel = A2(_mgold$elm_animation$Animation$velocity, t, _p49);
						return _mgold$elm_animation$Animation$A(A7(_mgold$elm_animation$Animation$AnimRecord, t, 0, newSpeed, _elm_lang$core$Maybe$Just(vel), _p48.ease, pos, newTo));
					}
				}
			}
		}
	});
	var _mgold$elm_animation$Animation$duration = F2(function (x, _p50) {
		var _p51 = _p50;
		return _mgold$elm_animation$Animation$A(_elm_lang$core$Native_Utils.update(_p51._0, {
			dos: _mgold$elm_animation$Animation$Duration(x)
		}));
	});
	var _mgold$elm_animation$Animation$speed = F2(function (x, _p52) {
		var _p53 = _p52;
		return _mgold$elm_animation$Animation$A(_elm_lang$core$Native_Utils.update(_p53._0, {
			dos: _mgold$elm_animation$Animation$Speed(_elm_lang$core$Basics$abs(x))
		}));
	});
	var _mgold$elm_animation$Animation$delay = F2(function (x, _p54) {
		var _p55 = _p54;
		return _mgold$elm_animation$Animation$A(_elm_lang$core$Native_Utils.update(_p55._0, { delay: x }));
	});
	var _mgold$elm_animation$Animation$ease = F2(function (x, _p56) {
		var _p57 = _p56;
		return _mgold$elm_animation$Animation$A(_elm_lang$core$Native_Utils.update(_p57._0, { ease: x }));
	});
	var _mgold$elm_animation$Animation$from = F2(function (x, _p58) {
		var _p59 = _p58;
		return _mgold$elm_animation$Animation$A(_elm_lang$core$Native_Utils.update(_p59._0, { from: x, ramp: _elm_lang$core$Maybe$Nothing }));
	});
	var _mgold$elm_animation$Animation$to = F2(function (x, _p60) {
		var _p61 = _p60;
		return _mgold$elm_animation$Animation$A(_elm_lang$core$Native_Utils.update(_p61._0, { to: x, ramp: _elm_lang$core$Maybe$Nothing }));
	});
	...
	var _user$project$Model$locallyStore = function _user$project$Model$locallyStore(model) {
		return _elm_lang$core$Task$succeed(model.counter);
	};
	...
	var _user$project$Model$ServerResponse = F4(function (a, b, c, d) {
		return { status: a, numberOfHands: b, numberOfWins: c, favoriteCasino: d };
	});
							...
							return function (g) {
								return function (h) {
									return function (i) {
										return function (j) {
											return function (k) {
												return { card: a, previousCard: b, remainingCards: c, currentTick: d, activeAnimation: e, counter: f, error: g, numberOfHands: h, numberOfWins: i, favoriteCasino: j, page: k };
											};
										};
									};
								};
	...
	var _user$project$Model$Storage = function _user$project$Model$Storage(a) {
		return { ctor: 'Storage', _0: a };
	};
	...
	var _user$project$Model$RemotelyStoreError = function _user$project$Model$RemotelyStoreError(a) {
		return { ctor: 'RemotelyStoreError', _0: a };
	};
	var _user$project$Model$LocallyStoreError = function _user$project$Model$LocallyStoreError(a) {
		return { ctor: 'LocallyStoreError', _0: a };
	};
	var _user$project$Model$Ceasars = { ctor: 'Ceasars' };
	var _user$project$Model$Belagio = { ctor: 'Belagio' };
	var _user$project$Model$toCasino = function _user$project$Model$toCasino(num) {
		var _p2 = num;
		switch (_p2) {
			case 0:
				return _elm_lang$core$Maybe$Just(_user$project$Model$Belagio);
			case 1:
				return _elm_lang$core$Maybe$Just(_user$project$Model$Ceasars);
			default:
				return _elm_lang$core$Maybe$Nothing;
		}
	};
	...
	var _user$project$Model$initialModel = {
		card: _elm_lang$core$Maybe$Nothing,
		previousCard: _elm_lang$core$Maybe$Nothing,
		remainingCards: _user$project$Model$shuffledDeck(0),
		currentTick: 0,
		activeAnimation: _elm_lang$core$Maybe$Nothing,
		counter: 0,
		error: _elm_lang$core$Maybe$Nothing,
		numberOfHands: 0,
		numberOfWins: 0,
		favoriteCasino: _user$project$Model$Unknown,
	...
	var _user$project$Main$toServerResponse = F4(function (status, hands, wins, casino) {
		var favoriteCasino = A2(_elm_lang$core$Maybe$withDefault, _user$project$Model$Unknown, A2(_elm_lang$core$Maybe$andThen, _user$project$Model$toCasino, A2(_elm_lang$core$Maybe$andThen, function (c) {
			return _elm_lang$core$Result$toMaybe(_elm_lang$core$String$toInt(c));
		}, casino)));
		return A4(_user$project$Model$ServerResponse, status, hands, wins, favoriteCasino);
	});
	var _user$project$Main$httpErrorToString = function _user$project$Main$httpErrorToString(error) {
		var _p0 = error;
		switch (_p0.ctor) {
			case 'Timeout':
				return 'Timeout';
	...
	var _user$project$Main$remotelyStore = F2(function (counter, model) {
		var url = A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:4000?count=', _elm_lang$core$Basics$toString(counter));
		var decoder = A5(_elm_lang$core$Json_Decode$map4, _user$project$Main$toServerResponse, A2(_elm_lang$core$Json_Decode$field, 'status', _elm_lang$core$Json_Decode$string), A2(_elm_lang$core$Json_Decode$field, 'number_of_hands', _elm_lang$core$Json_Decode$int), A2(_elm_lang$core$Json_Decode$field, 'number_of_wins', _elm_lang$core$Json_Decode$int), A2(_elm_lang$core$Json_Decode$field, 'favorite_casino', _elm_lang$core$Json_Decode$maybe(_elm_lang$core$Json_Decode$string)));
		return A2(_elm_lang$core$Task$mapError, function (_p1) {
			return _user$project$Model$RemotelyStoreError(_user$project$Main$httpErrorToString(_p1));
		}, A2(_elm_lang$core$Task$map, function (_p2) {
			return _elm_lang$core$String$toUpper(function (_) {
				return _.status;
			}(_p2));
		}, _elm_lang$http$Http$toTask(A3(_elm_lang$http$Http$post, url, _elm_lang$http$Http$emptyBody, decoder))));
	});
	...
	var _user$project$Main$update = F2(function (msg, model) {
		...
		switch (_p3.ctor) {
			case 'DealHand':
				var cmd = A2(_elm_lang$core$Task$attempt, _user$project$Model$Storage, A2(_user$project$Main$remotelyStore, model.counter, model));
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { counter: model.counter + 1 }), {
					ctor: '::',
					_0: cmd,
					_1: { ctor: '[]' }
				});
			case 'UrlChange':
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], A2(_user$project$Main$modelWithLocation, _p3._0, model), { ctor: '[]' });
			case 'NavigateTo':
				var cmd = _elm_lang$navigation$Navigation$newUrl(_user$project$Routes$pageToPath(_p3._0));
			...
			default:
				if (_p3._0.ctor === 'Ok') {
					var _p4 = A2(_elm_lang$core$Debug$log, 'Storage Ok', _p3._0._0);
					return A2(_elm_lang$core$Platform_Cmd_ops['!'], model, { ctor: '[]' });
				} else {
					var _p5 = A2(_elm_lang$core$Debug$log, 'Storage Err', _p3._0._0);
					return A2(_elm_lang$core$Platform_Cmd_ops['!'], model, { ctor: '[]' });
				}
		}
	});
	...
	var _user$project$Main$main = A2(_elm_lang$navigation$Navigation$program, _user$project$Model$UrlChange, {
		...
		subscriptions: function subscriptions(_p6) {
			return _elm_lang$core$Platform_Sub$none;
		}
	})();
