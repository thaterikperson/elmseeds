...
var _user$project$Model$AboutLinkClick = {ctor: 'AboutLinkClick'};
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('offset-by-eleven one column'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$a,
								{
									...
									_1: {
										ctor: '::',
										_0: _user$project$View$onLinkClick(_user$project$Model$AboutLinkClick),
										_1: {ctor: '[]'}
									}
								},
								{
		...
		switch (_p4.ctor) {
			...
			case 'CurrentTick':
				return A2(
					...
					{ctor: '[]'});
			case 'UrlChange':
				var _p6 = A2(_elm_lang$core$Debug$log, 'UrlChange', _p4._0);
				var newPage = function () {
					var _p7 = model.page;
					if (_p7.ctor === 'Home') {
						return _user$project$Model$About;
					} else {
						return _user$project$Model$Home;
					}
				}();
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					...
					{ctor: '[]'});
			case 'AboutLinkClick':
				var cmd = _elm_lang$navigation$Navigation$newUrl('/about');
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
