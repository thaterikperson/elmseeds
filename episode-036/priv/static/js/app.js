...
(function () {
	...
	var _user$project$Model$SizeUpdated = function _user$project$Model$SizeUpdated(a) {
			...
			_0: A2(_elm_lang$html$Html$div, {
				...
				_0: A2(_elm_lang$html$Html$div, {
					...
					_0: A2(_elm_lang$html$Html$h3, { ctor: '[]' }, {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Window Size'),
						_1: { ctor: '[]' }
					}),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html$div, { ctor: '[]' }, {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(_elm_lang$core$Basics$toString(model.windowSize.width)),
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html$label, { ctor: '[]' }, {
										ctor: '::',
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(_elm_lang$core$Basics$toString(model.windowSize.height)),
										_1: { ctor: '[]' }
									}
								}
							}
	...
	var _user$project$Main$update = F2(function (msg, model) {
		var _p0 = msg;
		return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { windowSize: _p0._0 }), { ctor: '[]' });
	});
	var _user$project$Main$initialSize = A2(_elm_lang$core$Task$perform, _user$project$Model$SizeUpdated, _elm_lang$window$Window$size);
	var _user$project$Main$main = _elm_lang$html$Html$program({
		init: { ctor: '_Tuple2', _0: _user$project$Model$initialModel, _1: _user$project$Main$initialSize },
		update: _user$project$Main$update,
		view: _user$project$View$mainView,
		subscriptions: function subscriptions(_p1) {
			return _elm_lang$window$Window$resizes(_user$project$Model$SizeUpdated);
		}
	})();
	...
	if (typeof _user$project$Main$main !== 'undefined') {
		_user$project$Main$main(Elm['Main'], 'Main', { "types": { "unions": { "Model.Msg": { "args": [], "tags": { "SizeUpdated": ["Window.Size"] } } }, "aliases": { "Window.Size": { "args": [], "type": "{ width : Int, height : Int }" } }, "message": "Model.Msg" }, "versions": { "elm": "0.18.0" } });
	}
