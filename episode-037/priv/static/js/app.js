...
(function () {
	...
	var _user$project$Model$Model = F2(function (a, b) {
		return { wins: a, games: b };
	});
	var _user$project$Model$GamesFetched = function _user$project$Model$GamesFetched(a) {
		return { ctor: 'GamesFetched', _0: a };
	};
	var _user$project$Model$WinsFetched = function _user$project$Model$WinsFetched(a) {
		return { ctor: 'WinsFetched', _0: a };
	};
	var _user$project$Model$FetchData = { ctor: 'FetchData' };
	var _user$project$Model$Success = function _user$project$Model$Success(a) {
		return { ctor: 'Success', _0: a };
	};
	var _user$project$Model$Failure = function _user$project$Model$Failure(a) {
		return { ctor: 'Failure', _0: a };
	};
	var _user$project$Model$Loading = { ctor: 'Loading' };
	var _user$project$Model$NotAsked = { ctor: 'NotAsked' };
	var _user$project$Model$initialModel = { wins: _user$project$Model$NotAsked, games: _user$project$Model$NotAsked };
			...
			_0: A2(_elm_lang$html$Html$div, {
				...
				_0: A2(_elm_lang$html$Html$div, {
					...
					_1: {
						...
						_0: A2(_elm_lang$html$Html$div, {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('row loading'),
							_1: { ctor: '[]' }
						}, {
							ctor: '::',
							_0: A2(_elm_lang$html$Html$div, {
								...
								_0: A2(_elm_lang$html$Html$h2, { ctor: '[]' }, {
									ctor: '::',
									_0: _elm_lang$html$Html$text('Wins'),
									_1: { ctor: '[]' }
								}),
								_1: {
									ctor: '::',
									_0: function () {
										...
										switch (_p0.ctor) {
											...
											default:
												return A2(_elm_lang$html$Html$h4, { ctor: '[]' }, {
													ctor: '::',
													_0: _elm_lang$html$Html$text(_elm_lang$core$Basics$toString(_p0._0)),
													_1: { ctor: '[]' }
												});
										}
									}(),
										...
										_0: function () {
											...
											switch (_p1.ctor) {
												...
												default:
													return A2(_elm_lang$html$Html$h4, { ctor: '[]' }, {
														ctor: '::',
														_0: _elm_lang$html$Html$text(_elm_lang$core$Basics$toString(_p1._0)),
														_1: { ctor: '[]' }
													});
											}
										}(),
						...
						_1: {
							...
							_0: A2(_elm_lang$html$Html$div, { ctor: '[]' }, {
								...
								_0: A2(_elm_lang$html$Html$button, {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Model$FetchData),
									_1: { ctor: '[]' }
								}, {
									ctor: '::',
									_0: _elm_lang$html$Html$text('Fetch Wins & Games'),
									_1: { ctor: '[]' }
								}),
								_1: { ctor: '[]' }
							}),
	...
	var _user$project$Main$update = F2(function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'FetchData':
				var gamesCmd = A2(_elm_lang$http$Http$send, _user$project$Model$GamesFetched, A2(_elm_lang$http$Http$get, 'http://localhost:4000/games', _elm_lang$core$Json_Decode$int));
				var winsCmd = A2(_elm_lang$http$Http$send, _user$project$Model$WinsFetched, A2(_elm_lang$http$Http$get, 'http://localhost:4000/wins', _elm_lang$core$Json_Decode$int));
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { wins: _user$project$Model$Loading, games: _user$project$Model$Loading }), {
					ctor: '::',
					_0: winsCmd,
					_1: {
						ctor: '::',
			...
			case 'WinsFetched':
				if (_p0._0.ctor === 'Ok') {
					return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
						wins: _user$project$Model$Success(_p0._0._0)
					}), { ctor: '[]' });
				} else {
					var _p2 = _p0._0._0;
					var _p1 = A2(_elm_lang$core$Debug$log, 'WinsFetched', _p2);
					return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
						wins: _user$project$Model$Failure(_p2)
					}), { ctor: '[]' });
				}
			default:
				if (_p0._0.ctor === 'Ok') {
					return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
						games: _user$project$Model$Success(_p0._0._0)
					}), { ctor: '[]' });
				} else {
					var _p4 = _p0._0._0;
					var _p3 = A2(_elm_lang$core$Debug$log, 'GamesFetched', _p4);
					return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
						games: _user$project$Model$Failure(_p4)
					}), { ctor: '[]' });
				}
		}
	});
	var _user$project$Main$main = _elm_lang$html$Html$program({
		...
		subscriptions: function subscriptions(_p5) {
			return _elm_lang$core$Platform_Sub$none;
		}
	})();
