...
(function () {
	...
	var _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom = _elm_lang$core$Json_Decode$map2(F2(function (x, y) {
		return y(x);
	}));
	var _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$hardcoded = function _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$hardcoded(_p0) {
		return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom(_elm_lang$core$Json_Decode$succeed(_p0));
	};
	var _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optionalDecoder = F3(function (pathDecoder, valDecoder, fallback) {
		var nullOr = function nullOr(decoder) {
			return _elm_lang$core$Json_Decode$oneOf({
				ctor: '::',
				_0: decoder,
				_1: {
		...
		var handleResult = function handleResult(input) {
			var _p1 = A2(_elm_lang$core$Json_Decode$decodeValue, pathDecoder, input);
			if (_p1.ctor === 'Ok') {
				var _p2 = A2(_elm_lang$core$Json_Decode$decodeValue, nullOr(valDecoder), _p1._0);
				if (_p2.ctor === 'Ok') {
	...
	var _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optionalAt = F4(function (path, valDecoder, fallback, decoder) {
		return A2(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optionalDecoder, A2(_elm_lang$core$Json_Decode$at, path, _elm_lang$core$Json_Decode$value), valDecoder, fallback), decoder);
	});
	var _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional = F4(function (key, valDecoder, fallback, decoder) {
		return A2(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optionalDecoder, A2(_elm_lang$core$Json_Decode$field, key, _elm_lang$core$Json_Decode$value), valDecoder, fallback), decoder);
	});
	var _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$requiredAt = F3(function (path, valDecoder, decoder) {
		return A2(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom, A2(_elm_lang$core$Json_Decode$at, path, valDecoder), decoder);
	});
	var _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required = F3(function (key, valDecoder, decoder) {
		return A2(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom, A2(_elm_lang$core$Json_Decode$field, key, valDecoder), decoder);
	});
	...
	var _user$project$Model$Person = F9(function (a, b, c, d, e, f, g, h, i) {
		return { username: a, url: b, bank: c, lastBetSize: d, handsPlayed: e, handsWon: f, averageBet: g, lastPlayedAt: h, favoriteCasino: i };
	});
	var _user$project$Model$Model = F8(function (a, b, c, d, e, f, g, h) {
		return { hand: a, remainingCards: b, numberOfHands: c, numberOfWins: d, isMenuOpen: e, dealerHand: f, rawPersonString: g, person: h };
	});
	var _user$project$Model$PersonRequestCompleted = function _user$project$Model$PersonRequestCompleted(a) {
		return { ctor: 'PersonRequestCompleted', _0: a };
	};
	...
	var _user$project$ViewHelper$onLinkClick = function _user$project$ViewHelper$onLinkClick(msg) {
	...
	var _user$project$View$pp = function _user$project$View$pp(input) {
		...
		return A2(_elm_lang$html$Html$div, {
			...
			_0: A2(_elm_lang$html$Html$div, {
				...
				_0: A2(_elm_lang$html$Html$div, {
					...
					ctor: '::',
					_0: A2(_elm_lang$html$Html$pre, { ctor: '[]' }, {
						ctor: '::',
						_0: _elm_lang$html$Html$text(A2(_elm_lang$core$Basics_ops['++'], '\"', A2(_elm_lang$core$Basics_ops['++'], model.rawPersonString, '\"'))),
						_1: { ctor: '[]' }
					}),
					_1: { ctor: '[]' }
				}),
				_1: {
					...
					_0: A2(_elm_lang$html$Html$div, {
						...
						_0: A2(_elm_lang$html$Html$pre, { ctor: '[]' }, {
							ctor: '::',
							_0: _elm_lang$html$Html$text(_user$project$View$pp(_elm_lang$core$Basics$toString(model.person))),
							_1: { ctor: '[]' }
						}),
						_1: { ctor: '[]' }
					}),
	...
	var _user$project$View$mainView = function _user$project$View$mainView(model) {
		return A2(_elm_lang$html$Html$div, { ctor: '[]' }, {
			ctor: '::',
			_0: _user$project$View$homeView(model),
			_1: { ctor: '[]' }
		});
	};

	var _user$project$Main$personDecoder = A4(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional, 'favoriteCasino', _elm_lang$core$Json_Decode$string, '', A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'lastPlayedAt', _elm_lang$core$Json_Decode$string, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'averageBet', _elm_lang$core$Json_Decode$float, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'handsWon', _elm_lang$core$Json_Decode$int, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'handsPlayed', _elm_lang$core$Json_Decode$int, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'lastBetSize', _elm_lang$core$Json_Decode$float, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'bank', _elm_lang$core$Json_Decode$float, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'url', _elm_lang$core$Json_Decode$string, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'username', _elm_lang$core$Json_Decode$string, _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$Person))))))))));
	var _user$project$Main$update = F2(function (msg, model) {
		...
		if (_p0.ctor === 'ToggleMenu') {
			...
			if (_p0._0.ctor === 'Ok') {
				var _p3 = _p0._0._0;
				var _p1 = function () {
					var _p2 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$personDecoder, _p3);
					if (_p2.ctor === 'Ok') {
						return {
							ctor: '_Tuple2',
							_0: _p3,
							_1: _elm_lang$core$Maybe$Just(_p2._0)
						};
					} else {
						return {
							ctor: '_Tuple2',
							_0: A2(_elm_lang$core$Debug$log, 'error', _p2._0),
				...
				var raw = _p1._0;
				var person = _p1._1;
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { person: person, rawPersonString: raw }), { ctor: '[]' });
			} else {
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
					person: _elm_lang$core$Maybe$Nothing,
					rawPersonString: _elm_lang$core$Basics$toString(_p0._0._0)
				}), { ctor: '[]' });
			}
		}
	});
	var _user$project$Main$initCmd = A2(_elm_lang$http$Http$send, _user$project$Model$PersonRequestCompleted, _elm_lang$http$Http$getString('/person'));
	var _user$project$Main$main = _elm_lang$html$Html$program({
		init: { ctor: '_Tuple2', _0: _user$project$Model$initialModel, _1: _user$project$Main$initCmd },
		update: _user$project$Main$update,
		view: _user$project$View$mainView,
		subscriptions: function subscriptions(_p4) {
			return _elm_lang$core$Platform_Sub$none;
		}
	})();
