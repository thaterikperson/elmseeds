...
(function () {
	...
	var _elm_lang$geolocation$Native_Geolocation = function () {
		...
		function toLocation(rawPosition) {
			...
			var altitude = rawAltitude === null || rawAccuracy === null ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just({ value: rawAltitude, accuracy: rawAccuracy });

			var heading = coords.heading;
			var speed = coords.speed;
			var movement = heading === null || speed === null ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(speed === 0 ? { ctor: 'Static' } : { ctor: 'Moving', _0: { speed: speed, degreesFromNorth: heading } });
	...
	var _elm_lang$geolocation$Geolocation$onSelfMsg = F3(function (router, location, state) {
		var _p0 = state;
		if (_p0.ctor === 'Nothing') {
			...
			return A2(_elm_lang$core$Task$andThen, function (_p3) {
				return _elm_lang$core$Task$succeed(state);
			}, _elm_lang$core$Task$sequence(A2(_elm_lang$core$List$map, send, _p0._0.subs)));
		}
	});
	...
	var _elm_lang$geolocation$Geolocation$onEffects = F3(function (router, subs, state) {
		var _p4 = state;
		if (_p4.ctor === 'Nothing') {
			var _p5 = subs;
			if (_p5.ctor === '[]') {
				...
				return A2(_elm_lang$core$Task$andThen, function (watcher) {
					return _elm_lang$core$Task$succeed(_elm_lang$core$Maybe$Just({ subs: subs, watcher: watcher }));
				}, _elm_lang$core$Process$spawn(A2(_elm_lang$geolocation$Geolocation$watch, _elm_lang$core$Platform$sendToSelf(router), function (_p6) {
					return _elm_lang$core$Task$succeed({ ctor: '_Tuple0' });
				})));
			}
		} else {
			...
			if (_p7.ctor === '[]') {
				...
				return _elm_lang$core$Task$succeed(_elm_lang$core$Maybe$Just({ subs: subs, watcher: _p9 }));
			}
		}
	});
	...
	var _elm_lang$geolocation$Geolocation$Location = F6(function (a, b, c, d, e, f) {
		return { latitude: a, longitude: b, accuracy: c, altitude: d, movement: e, timestamp: f };
	});
	var _elm_lang$geolocation$Geolocation$Altitude = F2(function (a, b) {
		return { value: a, accuracy: b };
	});
	var _elm_lang$geolocation$Geolocation$Options = F3(function (a, b, c) {
		return { enableHighAccuracy: a, timeout: b, maximumAge: c };
	});
	var _elm_lang$geolocation$Geolocation$Moving = function _elm_lang$geolocation$Geolocation$Moving(a) {
		return { ctor: 'Moving', _0: a };
	};
	var _elm_lang$geolocation$Geolocation$Static = { ctor: 'Static' };
	var _elm_lang$geolocation$Geolocation$Timeout = function _elm_lang$geolocation$Geolocation$Timeout(a) {
		return { ctor: 'Timeout', _0: a };
	};
	var _elm_lang$geolocation$Geolocation$LocationUnavailable = function _elm_lang$geolocation$Geolocation$LocationUnavailable(a) {
		return { ctor: 'LocationUnavailable', _0: a };
	};
	var _elm_lang$geolocation$Geolocation$PermissionDenied = function _elm_lang$geolocation$Geolocation$PermissionDenied(a) {
		return { ctor: 'PermissionDenied', _0: a };
	};
	var _elm_lang$geolocation$Geolocation$Tagger = function _elm_lang$geolocation$Geolocation$Tagger(a) {
		return { ctor: 'Tagger', _0: a };
	};
	var _elm_lang$geolocation$Geolocation$subMap = F2(function (func, _p10) {
		var _p11 = _p10;
		return _elm_lang$geolocation$Geolocation$Tagger(function (_p12) {
			return func(_p11._0(_p12));
		});
	});
	var _elm_lang$geolocation$Geolocation$changes = function _elm_lang$geolocation$Geolocation$changes(tagger) {
		return _elm_lang$geolocation$Geolocation$subscription(_elm_lang$geolocation$Geolocation$Tagger(tagger));
	};
	...
	var _user$project$Model$initialModel = { location: _elm_lang$core$Maybe$Nothing };
	var _user$project$Model$Model = function _user$project$Model$Model(a) {
		return { location: a };
	};
	var _user$project$Model$LocationUpdated = function _user$project$Model$LocationUpdated(a) {
		return { ctor: 'LocationUpdated', _0: a };
	};
	var _user$project$Model$FetchLocation = { ctor: 'FetchLocation' };

	var _user$project$View$mainView = function _user$project$View$mainView(model) {
		var locationDiv = function () {
			...
			if (_p0.ctor === 'Nothing') {
				...
				return A2(_elm_lang$html$Html$div, {
					...
					_0: A2(_elm_lang$html$Html$p, { ctor: '[]' }, {
						ctor: '::',
						_0: A2(_elm_lang$html$Html$label, { ctor: '[]' }, {
							ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(_elm_lang$core$Basics$toString(_p1.latitude)),
							_1: { ctor: '[]' }
						}
					}),
					_1: {
						...
						_0: A2(_elm_lang$html$Html$p, { ctor: '[]' }, {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(_elm_lang$core$Basics$toString(_p1.longitude)),
								_1: { ctor: '[]' }
							}
						}),
						_1: { ctor: '[]' }
			...
			_0: A2(_elm_lang$html$Html$div, {
				...
				_0: A2(_elm_lang$html$Html$div, {
					...
					_0: A2(_elm_lang$html$Html$h3, { ctor: '[]' }, {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Find My Location'),
						_1: { ctor: '[]' }
					}),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html$button, {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Model$FetchLocation),
							_1: { ctor: '[]' }
						}, {
							ctor: '::',
	...
	var _user$project$Main$update = F2(function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'FetchLocation') {
			var cmd = A2(_elm_lang$core$Task$attempt, _user$project$Model$LocationUpdated, _elm_lang$geolocation$Geolocation$nowWith({
				enableHighAccuracy: false,
				timeout: _elm_lang$core$Maybe$Just(2000),
				maximumAge: _elm_lang$core$Maybe$Nothing
			}));
			return A2(_elm_lang$core$Platform_Cmd_ops['!'], model, {
				ctor: '::',
				_0: cmd,
			...
			if (_p0._0.ctor === 'Ok') {
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
					location: _elm_lang$core$Maybe$Just(_p0._0._0)
				}), { ctor: '[]' });
			} else {
				var _p1 = A2(_elm_lang$core$Debug$log, 'LocationUpdated', _p0._0._0);
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], model, { ctor: '[]' });
			}
		}
	});
	...
	if (typeof _user$project$Main$main !== 'undefined') {
		_user$project$Main$main(Elm['Main'], 'Main', { "types": { "unions": { "Model.Msg": { "args": [], "tags": { "LocationUpdated": ["Result.Result Geolocation.Error Geolocation.Location"], "FetchLocation": [] } }, "Maybe.Maybe": { "args": ["a"], "tags": { "Just": ["a"], "Nothing": [] } }, "Geolocation.Movement": { "args": [], "tags": { "Moving": ["{ speed : Float, degreesFromNorth : Float }"], "Static": [] } }, "Result.Result": { "args": ["error", "value"], "tags": { "Ok": ["value"], "Err": ["error"] } }, "Geolocation.Error": { "args": [], "tags": { "PermissionDenied": ["String"], "LocationUnavailable": ["String"], "Timeout": ["String"] } } }, "aliases": { "Geolocation.Location": { "args": [], "type": "{ latitude : Float , longitude : Float , accuracy : Float , altitude : Maybe.Maybe Geolocation.Altitude , movement : Maybe.Maybe Geolocation.Movement , timestamp : Time.Time }" }, "Geolocation.Altitude": { "args": [], "type": "{ value : Float, accuracy : Float }" }, "Time.Time": { "args": [], "type": "Float" } }, "message": "Model.Msg" }, "versions": { "elm": "0.18.0" } });
	}
