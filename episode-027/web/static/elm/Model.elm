...
type Msg
    ...
    | MouseUp ( Float, Float )
    | IncomingCroppedFile Json.Decode.Value
...
type alias Model =
    ...
    , isBadFileType : Bool
    , mouseDownPosition : Maybe ( Float, Float )
    , mouseUpPosition : Maybe ( Float, Float )
    , mouseMovePosition : Maybe ( Float, Float )
    , isMovingMouse : Bool
    }
...
initialModel =
    ...
    , mouseUpPosition = Nothing
    , mouseMovePosition = Nothing
    , isMovingMouse = False
    }
