...
(function () {
	...
	var _user$project$Model$KeyUp = F2(function (a, b) {
		return { ctor: 'KeyUp', _0: a, _1: b };
	});
	var _user$project$Model$MessageUpdate = function _user$project$Model$MessageUpdate(a) {
		return { ctor: 'MessageUpdate', _0: a };
	};
	var _user$project$Model$AddMessage = { ctor: 'AddMessage' };
	var _user$project$Model$NoOp = { ctor: 'NoOp' };

	var _user$project$View$keyCodeAndShiftDecoder = A3(_elm_lang$core$Json_Decode$map2, _user$project$Model$KeyUp, _elm_lang$html$Html_Events$keyCode, A2(_elm_lang$core$Json_Decode$at, {
		ctor: '::',
		_0: 'shiftKey',
		_1: { ctor: '[]' }
	}, _elm_lang$core$Json_Decode$bool));
		...
		return A2(_elm_lang$html$Html$div, {
			...
			_0: A2(_elm_lang$html$Html$div, {
				...
				_0: A2(_elm_lang$html$Html$div, {
					...
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html$ul, { ctor: '[]' }, A2(_elm_lang$core$List$map, function (msg) {
							return A2(_elm_lang$html$Html$li, { ctor: '[]' }, A2(_elm_lang$core$List$intersperse, A2(_elm_lang$html$Html$br, { ctor: '[]' }, { ctor: '[]' }), A2(_elm_lang$core$List$map, _elm_lang$html$Html$text, _elm_lang$core$String$lines(msg))));
			...
			_1: {
				...
				_0: A2(_elm_lang$html$Html$form, {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Model$AddMessage),
					_1: { ctor: '[]' }
				}, {
					ctor: '::',
					_0: A2(_elm_lang$html$Html$div, {
						...
						_0: A2(_elm_lang$html$Html$div, {
							...
							ctor: '::',
							_0: A2(_elm_lang$html$Html$textarea, {
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Events$on, 'keyup', _user$project$View$keyCodeAndShiftDecoder),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('Your message…'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.message),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Model$MessageUpdate),
											_1: { ctor: '[]' }
										}
									}
								}
			...
			switch (_p0.ctor) {
				...
				case 'AddMessage':
					...
					if (_p1 === '') {
						...
						return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
							messages: { ctor: '::', _0: _p1, _1: model.messages },
							message: ''
						}), { ctor: '[]' });
					}
				case 'MessageUpdate':
					return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { message: _p0._0 }), { ctor: '[]' });
				default:
					var _p2 = { ctor: '_Tuple2', _0: _p0._0, _1: _p0._1 };
					if (_p2.ctor === '_Tuple2' && _p2._0 === 13 && _p2._1 === true) {
						var _v3 = _user$project$Model$AddMessage,
						    _v4 = model;
						msg = _v3;
						model = _v4;
						continue update;
	...
	var _user$project$Main$main = _elm_lang$html$Html$program({
		...
		subscriptions: function subscriptions(_p3) {
			return _elm_lang$core$Platform_Sub$none;
		}
	})();
	...
	if (typeof _user$project$Main$main !== 'undefined') {
		_user$project$Main$main(Elm['Main'], 'Main', { "types": { "unions": { "Model.Msg": { "args": [], "tags": { "MessageUpdate": ["String"], "AddMessage": [], "KeyUp": ["Int", "Bool"], "NoOp": [] } } }, "aliases": {}, "message": "Model.Msg" }, "versions": { "elm": "0.18.0" } });
	}
