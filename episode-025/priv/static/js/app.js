...
(function () {
	...
	var _user$project$Model$Model = F8(function (a, b, c, d, e, f, g, h) {
		return { hand: a, remainingCards: b, numberOfHands: c, numberOfWins: d, page: e, isMenuOpen: f, dealerHand: g, fileToUpload: h };
	});
		...
		switch (_p0.ctor) {
			...
			case 'Files':
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
					fileToUpload: _elm_lang$core$List$head(_p0._0)
				}), { ctor: '[]' });
			case 'ToggleMenu':
