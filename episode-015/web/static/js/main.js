					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {card: a, previousCard: b, remainingCards: c, currentTick: d, activeAnimation: e, counter: f, error: g, numberOfHands: h, numberOfWins: i, favoriteCasino: j};
									};
								};
							};
						};
	...
	function (status, hands, wins, casino) {
		...
		var favoriteCasino = A2(
			...
			A2(
				_elm_lang$core$Maybe$andThen,
				function (num) {
					return _user$project$Model$toCasino(num);
				},
				casinoResult));
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p3.ctor) {
			...
			default:
				if (_p3._0.ctor === 'Err') {
					var updated = A2(_user$project$Model$updateModelFromErrorType, _p3._0._0, model);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updated,
						{ctor: '[]'});
					...
					var updated = _elm_lang$core$Native_Utils.update(
						model,
						{numberOfHands: _p5.numberOfHands, numberOfWins: _p5.numberOfWins, favoriteCasino: _p5.favoriteCasino});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updated,
						{ctor: '[]'});
