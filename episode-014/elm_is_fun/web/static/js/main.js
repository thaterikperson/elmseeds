...
var _thaterikperson$elm_blackjack$Blackjack$cardValue = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1._0.type$;
	switch (_p2.ctor) {
		case 'King':
...
var _thaterikperson$elm_blackjack$Blackjack$isVirtualTen = function (card) {
	var _p3 = _thaterikperson$elm_blackjack$Blackjack$cardValue(card);
	if (_p3 === 10) {
		return true;
	} else {
		return false;
...
var _thaterikperson$elm_blackjack$Blackjack$isBlackjack = function (_p4) {
	var _p5 = _p4;
	var _p6 = _p5._0;
	if (((_p6.ctor === '::') && (_p6._1.ctor === '::')) && (_p6._1._1.ctor === '[]')) {
		var _p7 = {ctor: '_Tuple2', _0: _p6._0._0.type$, _1: _p6._1._0._0.type$};
		_v5_2:
		do {
			if (_p7.ctor === '_Tuple2') {
				if (_p7._0.ctor === 'Ace') {
					return _thaterikperson$elm_blackjack$Blackjack$isVirtualTen(_p6._1._0);
				} else {
					if (_p7._1.ctor === 'Ace') {
						return _thaterikperson$elm_blackjack$Blackjack$isVirtualTen(_p6._0);
					} else {
						break _v5_2;
					}
				}
...
var _thaterikperson$elm_blackjack$Blackjack$isSplittable = function (_p8) {
	var _p9 = _p8;
	var _p10 = _p9._0;
	if (((_p10.ctor === '::') && (_p10._1.ctor === '::')) && (_p10._1._1.ctor === '[]')) {
		return _elm_lang$core$Native_Utils.eq(_p10._0._0.type$, _p10._1._0._0.type$) || (_thaterikperson$elm_blackjack$Blackjack$isVirtualTen(_p10._0) && _thaterikperson$elm_blackjack$Blackjack$isVirtualTen(_p10._1._0));
	} else {
		return false;
	}
};
var _thaterikperson$elm_blackjack$Blackjack$typeOfCard = function (_p11) {
	var _p12 = _p11;
	return _p12._0.type$;
};
var _thaterikperson$elm_blackjack$Blackjack$suitOfCard = function (_p13) {
	var _p14 = _p13;
	return _p14._0.suit;
};
...
var _thaterikperson$elm_blackjack$Blackjack$addCardToHand = F2(
	function (card, _p15) {
		...
		return _thaterikperson$elm_blackjack$Blackjack$BjHand(
			A2(_elm_lang$core$List_ops['::'], card, _p16._0));
	});
...
var _thaterikperson$elm_blackjack$Blackjack$hasAce = function (_p17) {
	var _p18 = _p17;
	return A2(
		_elm_lang$core$List$any,
		function (_p19) {
			var _p20 = _p19;
			return _elm_lang$core$Native_Utils.eq(_p20._0.type$, _thaterikperson$elm_blackjack$Blackjack$Ace);
		},
		_p18._0);
};
var _thaterikperson$elm_blackjack$Blackjack$potentialScores = function (_p21) {
	var _p22 = _p21;
	var func = F2(
		function (_p23, scores) {
			var _p24 = _p23;
			var plus11 = A2(
				_elm_lang$core$List$map,
				function (s) {
	...
	var _p25 = A2(
		...
		function (_p26) {
			var _p27 = _p26;
			return _elm_lang$core$Native_Utils.eq(_p27._0.type$, _thaterikperson$elm_blackjack$Blackjack$Ace);
		},
		_p22._0);
	var aces = _p25._0;
	var noAces = _p25._1;
...
var _user$project$Model$remotelyStore = F2(
	function (counter, model) {
		var decoder = _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Basics_ops['%'], counter, 5),
			0) ? _elm_lang$core$Json_Decode$fail('Unable to save remotely.') : _elm_lang$core$Json_Decode$succeed(true);
		return A3(_evancz$elm_http$Http$post, decoder, 'http://localhost:4000', _evancz$elm_http$Http$empty);
	});
var _user$project$Model$locallyStore = function (model) {
	return _elm_lang$core$Native_Utils.eq(
		A2(_elm_lang$core$Basics_ops['%'], model.counter, 4),
		0) ? _elm_lang$core$Task$fail('Unable to save to local storage.') : _elm_lang$core$Task$succeed(model.counter);
};
...
var _user$project$Model$shuffledDeck = function (time) {
	...
	var types = _elm_lang$core$Native_List.fromArray(
		[_thaterikperson$elm_blackjack$Blackjack$Ace, _thaterikperson$elm_blackjack$Blackjack$King, _thaterikperson$elm_blackjack$Blackjack$Queen, _thaterikperson$elm_blackjack$Blackjack$Jack, _thaterikperson$elm_blackjack$Blackjack$Ten, _thaterikperson$elm_blackjack$Blackjack$Nine, _thaterikperson$elm_blackjack$Blackjack$Eight, _thaterikperson$elm_blackjack$Blackjack$Seven, _thaterikperson$elm_blackjack$Blackjack$Six, _thaterikperson$elm_blackjack$Blackjack$Five, _thaterikperson$elm_blackjack$Blackjack$Four, _thaterikperson$elm_blackjack$Blackjack$Three, _thaterikperson$elm_blackjack$Blackjack$Two]);
	var suits = _elm_lang$core$Native_List.fromArray(
		[_thaterikperson$elm_blackjack$Blackjack$Clubs, _thaterikperson$elm_blackjack$Blackjack$Diamonds, _thaterikperson$elm_blackjack$Blackjack$Hearts, _thaterikperson$elm_blackjack$Blackjack$Spades]);
	var cardsWithSuits = A2(
		_elm_lang$core$List$concatMap,
		function (type$) {
			return A2(
				_elm_lang$core$List$map,
				_thaterikperson$elm_blackjack$Blackjack$newCard(type$),
				suits);
		},
		types);
...
var _user$project$Model$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {card: a, previousCard: b, remainingCards: c, currentTick: d, activeAnimation: e, counter: f, error: g};
	});
var _user$project$Model$StorageSucceed = function (a) {
	return {ctor: 'StorageSucceed', _0: a};
};
var _user$project$Model$StorageFail = function (a) {
	return {ctor: 'StorageFail', _0: a};
};
...
var _user$project$View$mainView = function (model) {
	var deckView = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('deck')
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
	var x = function () {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('row card-row')
					]),
				_elm_lang$core$Native_List.fromArray(
					[deckView, cardView, previousCardView])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('one-third column')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Events$onClick(_user$project$Model$DealHand)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
...
var _user$project$Main$remotelyStore = F2(
	function (counter, model) {
		return A2(_user$project$Model$remotelyStore, counter, model);
	});
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p1 = function () {
			var _p2 = model.remainingCards;
			if ((_p2.ctor === '::') && (_p2._1.ctor === '::')) {
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Maybe$Just(_p2._0),
					_1: _elm_lang$core$Maybe$Just(_p2._1._0),
					_2: _p2._1._1
				};
			} else {
				return {
		...
		var leftCard = _p1._0;
		var rightCard = _p1._1;
		var remainingCards = _p1._2;
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'DealHand':
					...
					return A2(
						...
						function (_p4) {
							return _user$project$Model$RemotelyStoreError(
								_user$project$Main$httpErrorToString(_p4));
						},
				...
				var cmd = A3(
					...
					_user$project$Model$StorageFail,
					_user$project$Model$StorageSucceed,
					A2(_elm_lang$core$Task$andThen, localTask, remoteTask));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					updated,
					_elm_lang$core$Native_List.fromArray(
			...
			case 'CurrentTick':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'StorageFail':
				var updated = A2(_user$project$Model$updateModelFromErrorType, _p3._0, model);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					updated,
					_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$initialState = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
